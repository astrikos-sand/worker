...
class API:
    ...
    def request(self, method: str, url: str, data: dict = None, headers: dict = None) -> str:
        try:
            response = self.session.request(method=method, url=f"{self.base_url}{url}", headers=headers, json=data)
